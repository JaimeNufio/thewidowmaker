...
const int RocketLauncher_MOD_AMMO = BIT(0);
...
STATE("Reload", rvWeaponRocketLauncher::State_Reload)
END_CLASS_STATES
...
/*
================
rvWeaponRocketLauncher::State_Reload
================
*/
stateResult_t rvWeaponRocketLauncher::State_Reload(const stateParms_t& parms) {
	enum {
		STAGE_INIT,
		STAGE_WAIT,
	...
	case STAGE_INIT:
		...
		if (mods & RocketLauncher_MOD_AMMO) {
